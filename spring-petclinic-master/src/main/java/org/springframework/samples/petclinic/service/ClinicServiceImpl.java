...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Autowired
    public ClinicServiceImpl(PetRepository petRepository, VetRepository vetRepository, OwnerRepository ownerRepository, StudentRepository studentRepository,VisitRepository visitRepository) {
